...
%
%   info struct fields:
%       .student_id   - 202220808 (string, 예: '20210123')
%       .name         - 이찬민 (string)
%       .team_members - (cell array of struct, 개인 제출 시 빈 cell)
%       .course       - C049/자동제어
%       .ai_usage     - Gemini (ChatGPT, Claude 등) 사용 여부 + 범위 (string)
%
%   본 파일을 수정하지 않으면 -5점 감점 + 채점 시트 매칭 불가.

    info.student_id   = '202220808';
    info.name         = '이찬민';
    ...
    info.ai_usage = 'Gemini used to almost';
